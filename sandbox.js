...
const questions = [
    {
        title : 'What is the name of the disease in man arising out of Vitamin B1 deficiency?',
        options : [
            'Scurvy', 
            'Beriberi', 
            'Pellagra', 
    ...
    {
        title : 'The deficiency of which of the following group of nutrients affects the skin ?',
        options : [
    ...
    {
        title : ' What does niacin deficiency cause ?',
        options : [
            'Acne',
            'Pellagra',
            'Boils',
    ...
    {
        title : 'What are the effects of Vitamin B6 deficiency?',
        options : [
            'Beriberi',
            'Scurvy',
    ...
    {
        title : 'Deficiency of Vitamin D gives rise to :',
        options : [
            'Hernia',
            'Arthrities',
            'Rickets',
    ...
    {
        title : 'What does Vitamin K deficiency lead to ?',
        options : [
    ...
    {
        title: 'Which of these is a cause of heart disease?' ,
        options : [
            'Stroke',
            'Arthritis',
